...
public class Move_Climbers extends CommandBase {
     ...
     */
    public Move_Climbers(Climber_Subsystem subsystem) {
  ...
  public void execute() {
    ...
    double rightJoyY = RobotContainer.j_stick_control.getRawAxis(Constants.AXIS_LEFT_Y);
    rightJoyY = rightJoyY * 0.6;

    m_subsystem.Move_Climbers(leftJoyY, rightJoyY);
  }
